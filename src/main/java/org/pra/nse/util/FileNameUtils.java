...
public class FileNameUtils {
    ...
    private String getLatestFileName(String fileDir, String filePrefix, String fileExt, int occurrence, LocalDate localDate) {
        ...
        for(int i=0; i<occurrence; i++) {
            do {
                ...
                if(date.compareTo(ApCo.DOWNLOAD_FROM_DATE) < 0) break;
            } while(true);
        }
    ...
    public void validate() {
        ...
        String mtoDate = getLatestFileNameFor(ApCo.MT_FILES_PATH, ApCo.MT_DATA_FILE_PREFIX, ApCo.PRA_DATA_FILE_EXT, 1).substring(32);
        if(cmDate.equals(foDate) && cmDate.equals(mtoDate)) {
