...
public class AppConstants {
    ...
    public static String MAT_DIR_NAME = "pra-nse-mat";
    public static String CALC_DIR_NAME = "pra-nse-calculated-data";

    public static String CM_FILE_NAME_DATE_FORMAT = "ddMMMyyyy";
    public static String FO_FILE_NAME_DATE_FORMAT = "ddMMMyyyy";
    public static String MAT_FILE_NAME_DATE_FORMAT = "ddMMyyyy";
